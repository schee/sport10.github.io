  ...
  return (
    <div style={{
      ...
      <div style="display: flex; align-items: center; gap: 8; margin-bottom: 8">
        <span style="background: TYPE_COLORS[d.type]; color: #0d1117; border-radius: 4; padding: 1px 6px; font-size: 10; font-weight: 700">d.type</span>
        <span style="color: #8b949e">d.date d.time</span>
      </div>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4px 16px; margin-bottom: 8">
        <div><span style="color: #8b949e">負重 </span><span style="color: TYPE_COLORS[d.type]; font-weight: 700">d.weight kg</span></div>
      ...
      <div style="color: #8b949e; font-size: 11; border-top: 1px solid #21262d; padding-top: 8">d.note</div>
    </div>
  );
};
...
export default function AllTrainingChart() 
  ...
  return (
    <div style="background: #0d1117; min-height: 100vh; padding: 36px 28px; font-family: JetBrains Mono; color: #e6edf3">
      /* Header */
      <div style="margin-bottom: 32">
        <div style="color: #8b949e; font-size: 10; letter-spacing: 4; text-transform: uppercase; margin-bottom: 6">
          完整訓練日誌分析
        </div>
        <h1 style="font-size: 28; font-weight: 800; margin: 0; background: linear-gradient(90deg; -webkit-background-clip: text; -webkit-text-fill-color: transparent">
          負重進展總覽
        </h1>
        <div style="color: #8b949e; font-size: 11; margin-top: 4">
          2025.02.16 ─ 2026.03.04 &nbsp;｜&nbsp; 22 筆訓練記錄
        </div>
      </div>

      /* Stats */
      <div style="display: flex; gap: 12; margin-bottom: 28; flex-wrap: wrap">
        [
          ...
          <div key=s.label style="background: #161b22; border: 1px solid #21262d; border-radius: 8; padding: 14px 20px; flex: 1 1 110px">
            <div style="color: #8b949e; font-size: 9; letter-spacing: 2; margin-bottom: 4">s.label</div>
            <div style="color: s.color; font-size: 22; font-weight: 700">s.value</div>
          </div>
        ))}
      </div>

      /* Type filter */
      <div style="display: flex; gap: 8; margin-bottom: 24; flex-wrap: wrap">
        <button onclick=() => setActiveType(null) style="background: activeType === null ? #e6edf3 : #21262d; color: activeType === null ? #0d1117 : #8b949e; border: none; border-radius: 20; padding: 5px 14px; font-family: inherit; font-size: 11; cursor: pointer; font-weight: 700">全部</button>
      ...
      <div style="background: #161b22; border: 1px solid #21262d; border-radius: 12; padding: 20px 12px 12px; margin-bottom: 20">
        <div style="color: #8b949e; font-size: 10; letter-spacing: 3; margin-bottom: 16; padding-left: 8">
          各次訓練負重 (KG)
        </div>
        <ResponsiveContainer width="100%" height=260>
          <ComposedChart data=filteredData margin={ top: 8, right: 16, left: 0, bottom: 40 }>
            ...
            <ReferenceLine y=parseFloat(avgWeight) stroke="#8b949e" strokeDasharray="4 4" strokeOpacity=0.5
              label={ value: `平均 ${avgWeightkg`, fill: "#8b949e", fontSize: 9, position: "insideTopRight" }}>
      ...
      <div style="background: #161b22; border: 1px solid #21262d; border-radius: 12; padding: 20px 12px 12px; margin-bottom: 20">
        ...
        <div style="color: #8b949e; font-size: 9; padding-left: 8; margin-top: 4">
          ＊ 橘線為均速（min/km）；烘爐地 3/04 均速 37.1 已排除以利圖表可讀性
        </div>
      </div>

      /* Legend */
      <div style="display: flex; gap: 16; flex-wrap: wrap; margin-top: 8">
        Object.entries(TYPE_COLORS).map(([type, color]) => (
          <div key={type style="display: flex; align-items: center; gap: 6">
            <div style="width: 10; height: 10; border-radius: 2; background: color">
            <span style="color: #8b949e; font-size: 11">type</span>
          </div>
        ))}
      </div>

      <div style="color: #30363d; font-size: 9; text-align: right; margin-top: 20">
